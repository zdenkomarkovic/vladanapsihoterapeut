        ...
        <div className="grid md:grid-cols-2 gap-14 lg:gap-24 items-start">
          ...
          <div>
            ...
            <p className="font-sans text-muted leading-relaxed mb-10">
              Pošaljite upit sa vašim imenom i prezimenom, mejlom, brojem
              telefona i okvirnim terminima koji vam odgovaraju. Nakon upita
              stižete odgovor sa dostupnim terminima i daljim informacijama.
            </p>
            ...
            {status === "success" ? (
              <div className="text-center py-8">
                ...
                <p className="font-sans text-muted text-sm leading-relaxed mb-6">
                  Hvala vam. Odgovor sa dostupnim terminima stiže u najkraćem
                  mogućem roku.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <p className="font-sans text-muted text-sm leading-relaxed mb-8">
                  U upitu navedite ime i prezime, mejl, telefon i termine koji
                  vam okvirno odgovaraju.
                </p>
                ...
                {status === "error" && (
                  <p className="font-sans text-sm text-red-500 mb-4">
                    {errorMsg}
                  </p>
                )}
