...
const generalMailto = `mailto:${EMAIL}?subject=${encodeURIComponent(
  "Upit / Zakazivanje"
        ...
        <div className="grid md:grid-cols-2 gap-14 lg:gap-24 items-start">
          ...
          <div>
            ...
            <p className="font-sans text-muted leading-relaxed mb-10">
              Pošaljite upit sa vašim imenom i prezimenom, mejlom, brojem telefona
              i okvirnim terminima koji vam odgovaraju. Nakon upita stižete odgovor
              sa dostupnim terminima i daljim informacijama.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-sans text-xs text-muted uppercase tracking-wider mb-0.5">Email</p>
                  <a href={`mailto:${EMAIL}`} className="font-sans text-charcoal hover:text-sage transition-colors text-sm">
                    {EMAIL}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-sans text-xs text-muted uppercase tracking-wider mb-0.5">Instagram</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-sans text-xs text-muted uppercase tracking-wider mb-0.5">TikTok</p>
          ...
          <div className="bg-white border border-sand-light rounded-3xl p-8 lg:p-10">
            ...
            <p className="font-sans text-muted text-sm leading-relaxed mb-8">
              U upitu navedite ime i prezime, mejl, telefon i termine koji vam okvirno odgovaraju.
              Odgovor stiže sa dostupnim terminima i svim potrebnim informacijama.
            </p>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={field} className="border border-sand-light rounded-xl px-4 py-3 bg-cream/50">
                  <span className="font-sans text-muted text-sm">{field}</span>
                </div>
              ))}
            </div>
            ...
            <a
              href={generalMailto}
              className="block w-full text-center font-sans text-sm bg-sage text-white px-8 py-4 rounded-full hover:bg-sage-dark transition-colors"
            >
              Pošalji upit putem mejla
            </a>

            <p className="font-sans text-muted text-xs text-center mt-4 leading-relaxed">
              Klik otvara vaš mejl klijent sa popunjenim podacima.
            </p>
          </div>
        </div>
      </div>
